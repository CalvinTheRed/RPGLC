...
public class RepeatDamageDiceTest {
    ...
    [Fact(DisplayName = "repeats critical hit damage collection die (default)")]
    public void RepeatsCriticalHitDamageCollectionDieDefault() {
        RPGLContext context = new DummyContext();
        RPGLEffect rpglEffect = new();
        Subevent subevent = new CriticalHitDamageCollection().JoinSubeventData(new JsonObject().LoadFromString("""
            {
                "damage": [
                    {
                        "damage_type": "fire",
    ...
    [Fact(DisplayName = "repeats critical hit damage collection die (customized)")]
    public void RepeatsCriticalHitDamageCollectionDieCustomized() {
        RPGLContext context = new DummyContext();
        RPGLEffect rpglEffect = new();
        Subevent subevent = new CriticalHitDamageCollection().JoinSubeventData(new JsonObject().LoadFromString("""
            {
